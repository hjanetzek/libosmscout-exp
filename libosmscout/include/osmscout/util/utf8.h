...
/*  $Id: utf8.hpp 33815 2007-05-04 17:18:18Z kazimird $
 * ===========================================================================
 *
...
//
//NCBI_XUTIL_EXPORT
extern char StringToChar(const std::string&      src,
                         size_t*            seq_len     = 0,
...
//
class OSMSCOUT_API Utf8Util {
public:
  static std::string StringToAscii(const std::string& src,
                            bool downcase = false);
};
...
//
//NCBI_XUTIL_EXPORT
extern long StringToCode(const std::string&      src,
                         size_t*            seq_len = 0,
                         EConversionStatus* status  = 0);
...
//
//NCBI_XUTIL_EXPORT
extern std::vector<long> StringToVector(const std::string& src);
