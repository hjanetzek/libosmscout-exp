    ...
    for (uint32_t level=0;
      ...
      for (size_t i=0; !stopArea && i<cellRefs.size(); i++) {
        ...
        if (cell->value.children[0]!=0) {
          // top left
          size_t x=cx*csize;
          size_t y=cy*csize+csize;

          if ((minX<x+csize)&&(minY<y+csize)&&(x<maxX)&&(y<maxY)) {
            //std::cerr << "add child: 01" << std::endl;
        ...
        if (cell->value.children[1]!=0) {
          // top right
          size_t x=cx*csize+csize;
          size_t y=cy*csize+csize;

          if ((minX<x+csize)&&(minY<y+csize)&&(x<maxX)&&(y<maxY)) {
            //std::cerr << "add child: 11" << std::endl;
        ...
        if (cell->value.children[2]!=0) {
          ...
          if ((minX<x+csize)&&(minY<y+csize)&&(x<maxX)&&(y<maxY)) {
            //std::cerr << "add child: 00" << std::endl;
        ...
        if (cell->value.children[3]!=0) {
          ...
          if ((minX<x+csize)&&(minY<y+csize)&&(x<maxX)&&(y<maxY)) {
            //std::cerr << "add child: 10" << std::endl;
